...
<img src="images/ch7 Process/image-20220323215907450.png" alt="image-20220323215907450" style="zoom: 67%;" />
...
Stack是一种后进先出 (LIFO) 数据结构，最后一个被推到Stack上的内容就是从顶部弹出的第一个内容。不允许从Stack的中间插入或移除。因此Stack必须至少支持两种操作：`push ` 和  `pop` ；其他操作也是可以，但不是必需的。
 ...
 ![stack2](images/ch7 Process/stack2.gif)

在Linux中，`ulimit -a` 是可以获取和设置用户限制的函数

![image-20220323223534060](images/ch7 Process/image-20220323223534060.png)
...
![heap-Demonstration](images/ch7 Process/heap-animation.gif)
...
![两态过程模型图](images/ch7 Process/2state.png)
...
![三态过程模型图](images/ch7 Process/3statemodel.png)
...
![具有挂起状态的五态进程模型图](images/ch7 Process/5state1suspend.png)
...
![具有两个挂起状态的五状态进程模型图](images/ch7 Process/2state2suspended2.png)
...
![Process Queue](images/ch7 Process/Process-Queue-2.png)
...
![img](images/ch7 Process/4_01_ThreadDiagram.jpg)
...
![img](images/ch7 Process/many-to-one.png)
...
![img](images/ch7 Process/many-to-many.png)
...
![img](images/ch7 Process/two-level.png)
...
![img](images/ch7 Process/what-is-context-switching-in-operating-system-context-switching-flow.png)
...
<img src="images/ch7 Process/image-20220404233414592.png" alt="image-20220404233414592" style="zoom: 80%;" />

<img src="images/ch7 Process/image-20220404233344415.png" alt="image-20220404233344415" style="zoom:80%;" />
...
![image-20220404233011879](images/ch7 Process/image-20220404233011879.png)
