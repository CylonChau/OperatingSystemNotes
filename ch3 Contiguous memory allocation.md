...
![image-20220425192237300](images/ch3 Contiguous memory allocation/image-20220425192237300.png)
 3.OS管理内存时需要完成的目标
...
④ 虚拟化：更多的地址空间（利用磁盘的空间)
![image-20220425192251895](images/ch3 Contiguous memory allocation/image-20220425192251895.png)
...
![image-20220425192335531](images/ch3 Contiguous memory allocation/image-20220425192335531.png)
...
![image-20220425192353658](images/ch3 Contiguous memory allocation/image-20220425192353658.png)
...
![image-20220425194557713](images/ch3 Contiguous memory allocation/image-20220425194557713.png)

### 4. 内存安全监测：检查运行的内存是否在对应内存空间范围内

![image-20220425194611872](images/ch3 Contiguous memory allocation/image-20220425194611872.png)
